...
$.widget("javobyte.rouletteWheel", {
  ...
  _create: function () {
    ...
    if (canvas.getContext) {
      ...
      this._options.textRadius =
        (this._options.radius + this._options.innerRadius) / 2;
      ...
      this.element.click(function (e) {
        ...
        if (
          ...
          Math.pow(widget._options.innerRadius, 2)
        ) {
  ...
  _rotate: function () {
    ...
    var spinAngle =
      this._options.spinAngleStart -
      easeOut(
        this._options.spinTime,
        0,
        this._options.spinAngleStart,
        this._options.spinTimeTotal
      );
  ...
  spin: function () {
    ...
    this._options.spinTimeTotal =
      Math.random() * 3000 + 4 * 1000 + 2 * Math.random();
    this._rotate();
  },
